...
# fastq file is created by fasta file; so we assume no primer.
# ---------- Check Primer --------------- #
...
# 
# path    <- "/Users/huangc9/Documents/Ben research/Publishable/1_DADA2/Example data/Ta/"
...
path <- "/home/chuang19/Ben_data/Tabatabaei2018/Tab2018_fastq" #path to a sample fastq file
...
# plotQualityProfile(fnFs[1:2])#trimming after 220bp
...
#filter and trimming
out <- filterAndTrim(fnFs, filtFs, truncLen=c(252),
...
ASV_Ta   <- seqtab.nochim
track_Ta <- track

outpath <- "/home/chuang19/Ben_data/Tabatabaei2018/" 
save(ASV_Ta, track_Ta, file = paste0(outpath,"Ta_dada2.RData"))
